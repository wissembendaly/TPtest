...
export class CinemaListItem  extends PickType(Cinema, ["_id","name", "description", "imageUrl"]) {
    ...
    constructor(cinema:Cinema) {
        ...
        this.isOpen = ((currentTime > cinema.openingTime) && (currentTime < cinema.closingTime));
    }
}